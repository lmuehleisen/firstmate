...
state/               runtime records and signals; gitignored
  ...
  .stow-audit/       stow-pass before-state snapshot of the startup-memory files; bin/fm-stow-audit.sh owns it (snapshot writes, verify diffs), and it is safe to delete between passes
