...
agy keeps its folder-trust dialog off the launch path through physically resolved directory grants rather than a trust-store write, and `references/harness/agy.md` owns why.
